...
import org.apache.logging.log4j.core.DnLogEvent;
...
public abstract class AbstractJSONLayout extends AbstractStringLayout {
    ...
    protected AbstractJSONLayout(final Configuration config, final ObjectWriter objectWriter, final Charset charset,
